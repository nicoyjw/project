...
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:8px;">
        <div class="printSource" style="float: left; margin-left: 4px; margin-top: 10px;margin-right: 4px; width: 355px; height: 350px;">
            ...
            <div style="width: 320px; text-align: center; margin-top: 2px; height: 60px; font-family: Arial;"><span><img src='common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=0&font_size=0&text=<!--{$order.track_no}-->&thickness=45&start=NULL&code=BCGcode128' style='width: 250px;height:40px;'/></span><br />
            <b><!--{$order.track_no}--></b></div>
            <div style="border: 1px #707070 solid; border-bottom: 0px; border-left: 0px; border-right: 0px; font-family: Arial;
            height: 0px;">
            <div style="width: 320px; line-height:17px;height:18px; font-size:13px;padding-left:4px; font-family: Arial;">Ref No: <!--{$order.paypalid}--></div>
            </div>
            </div>
            </div>
    </td>   
...
<!--{elseif $type eq 21233}--><!--中国邮政平常小包10*10-->
<style>
    .clear:after{content:'.';display:block;height:0;visibility:hidden;clear:both;}
    .clear{zoom:1;}
    *{padding:0;margin:0;font-size:12px;}
