...
<!--{elseif $type eq 169}--><!--erp invoice-->
<!--{foreach from =$orders item = order name=orderitem}-->
<div >
<table border="0" cellpadding="0" cellspacing="0" width="794">
  <tr>
          ...
          <tr>
            ...
            <td width="57%">
              <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="word-break:break-all">
                <tr>
                  <td width="61%" style="font-size:14px; font-family:Arial, Helvetica, sans-serif;font-weight:bold;" bordercolor="#000000" align="right">Subtotal:</td>
                  <td width="39%" style="font-size:14px; font-family:Arial, Helvetica, sans-serif;font-weight:bold;" bordercolor="#000000" align="center">?总金额</td>
                </tr>
                <tr>
                  <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;font-weight:bold;" bordercolor="#000000" align="right">Insurance(optional):</td>
                  <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;font-weight:bold;" bordercolor="#000000" align="center">?留空</td>
                </tr>
                <tr>
                  <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;font-weight:bold;" bordercolor="#000000" align="right">Postage:</td>
                  <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;font-weight:bold;" bordercolor="#000000" align="center">?运费</td>
                </tr>
                <tr>
                  <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;font-weight:bold;" bordercolor="#000000" align="right">Credit Card Surcharge*:</td>
                  <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;font-weight:bold;" bordercolor="#000000" align="left">?根据付款方式的选择来<br>
                    计算。<span style="font-size:10px; font-family:Arial, Helvetica, sans-serif;">*1.5% surcharge on VISA,Master & Paypal, 3% surcharge on AMEX. </span><br>
                    =(总金额+运费)*对应的<br>
                    百分比.如果选择其他的付<br>
                    款方式的话，此处为0</td></tr></table>
              <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="word-break:break-all"><tr></tr></table>
              <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="word-break:break-all"><tr>
                </tr>
                <tr>
                  <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;font-weight:bold;" bordercolor="#000000" align="right">Total (inc GST):</td>
                  <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;font-weight:bold;" bordercolor="#000000" align="center">?总金额+运费+Credit Card Surcharge</td>
                </tr>
                <tr>
                  <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;font-weight:bold;" bordercolor="#000000" align="right">GST:</td>
                  <td style="font-size:14px; font-family:Arial, Helvetica, sans-serif;font-weight:bold;" bordercolor="#000000" align="center">?（总金额+运费）/11</td>
                </tr>
                <tr>
                  <td colspan="2" align="left" bordercolor="#000000" style="font-size:10px; font-family:Arial, Helvetica, sans-serif;">*1.5% surcharge on VISA,Master & Paypal, 3% surcharge on AMEX.                    </td>
                </tr>
                </table>
            </td>
          </tr>
