...
<!--{elseif $type eq 222}--><!-打印地址-><!--小包10*10-->
        <style>
            *{margin:0;padding:0;}
            .clear:after{height:0;content:'.';visibility:hidden;display:block;clear:both;}
            .clear{zoom:1;}
            body{background:white;}
            
            /* 1 */
            .order_1{width:350px;height:304px;padding:4px;float:left;overflow:hidden;border:1px dashed #231916;}
            .order_1 .header{width:350px;height:70px;border-bottom:2px solid #231916;margin-bottom:6px;overflow:hidden;}
            .order_1 .header .p1{width:213px;float:left;font-size:12px;line-height:12px;padding-left:10px;}
            .order_1 .header .p2{width:115px;border:1px solid #231916;float:right;font-size:10px;line-height:10px;padding:2px 0 2px 4px;overflow:hidden;}
            
            .order_1 .footer{height:228px;width:350px;}
            .order_1 .footer_l{width:220px;float:left;padding-left:10px;}
            .order_1 .footer_r{width:116px;float:left;}
            .order_1 .footer_l .p1{float:left;width:25px;font-size:16px;}
            .order_1 .footer_l .p2{float:left;width:190px;font-size:16px;line-height:14px;overflow:hidden;word-break:break-all;word-wrap:break-word;margin-bottom:10px;padding-right:5px;}
            
            .order_1 .footer_r_h{width:116px;height:60px;border:1px solid #231916;text-align:center;margin-bottom:6px;}
            .order_1 .footer_r_h .p1{height:24px;font-size:20px;font-weight:bold;border-bottom:1px solid #231916;line-height:28px;}
            .order_1 .footer_r_h .p2{font-size:26px;font-weight:bold;}
            .order_1 .footer_r_t{width:116px;border:1px solid #231916;}
            .order_1 .footer_r_t .p1{font-size:12px;line-height:10px;border-bottom:1px solid #231916;padding:2px;height:80px;overflow:hidden;}
            .order_1 .footer_r_t .p2{border-bottom:1px solid #231916;font-size:12px;line-height:14px;padding:2px 4px;}
            .order_1 .footer_r_t .p3{font-size:12px;line-height:12px;padding:2px 4px;}
            
            /* 2 */ 
            .order_2{width:320px;height:304px;padding:4px;float:left;border:1px dashed #231916;overflow:hidden;}
            .order_2 .tab1{overflow:hidden;width:320px;height:90px;}
            .order_2 .tab2{overflow:hidden;width:320px;height:214px;}
            .order_2 .tr1 td{border-bottom:1px solid #231916;}
            .order_2 .tr1 .span1{font-size:11px;font-weight:bold;line-height:12px;}
            .order_2 .tr1 .span2{font-size:10px;line-height:12px;}
            .order_2 .tr2 td{border-bottom:1px solid #231916;font-size:12px;line-height:14px;border-right:1px solid #231916;}
            .order_2 .tr3{height:20px;overflow:hidden;}
            .order_2 .tr3 td{border-bottom:1px solid #231916;font-size:12px;line-height:10px;border-right:1px solid #231916;font-weight:bold;height:28px;}
            .order_2 .tr4 td{font-size:10px;border-right:1px solid #231916;}
            .order_2 .tr5 td{font-size:10px;border-right:1px solid #231916;border-bottom:1px solid #231916;}
            .order_2 .tr6 td{font-size:12px;border-bottom:1px solid #231916;}
            .order_2 .tr7 td{font-size:12px;border-right:1px solid #231916;height:20px;}
            .order_2 .tr8 td{font-size:12px;border-bottom:1px solid #231916;border-right:1px solid #231916;height:20px;}
            .order_2 .tr8 .td1,.order_2 .tr7 .td1{width:100px;}
            .order_2 .tr9 td{font-size:10px;border-right:1px solid #231916;border-bottom:1px solid #231916;height:25px;}
            .order_2 .tr10 td{font-size:10px;line-height:8px;border-bottom:1px solid #231916;height:30px;}
            .order_2 .tr11 td{font-size:10px;line-height:8px;}
            .order_2 .tr12 td{font-size:12px;padding-bottom:28px;}
            
        </style>
        
        <!--{foreach from =$orders item = order name=orderitem }-->
        <div class='clear' style='margin-bottom:10px;'>
        <div class="order_1 clear">
            ...
            <div class='header clear'>
                ...
                <p class='p2' style='font-size:10px !important;line-height:10px !important;'>
            ...
            <div class='footer clear' style='position:relative;'>
                <div class='footer_l'>
                    <p class='p1'>TO:</p>
                    <p class='p2'>
                    ...
                    <div class='sn' style='text-align:center;'><img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=8&text=<!--{$order.track_no}-->&thickness=30&start=NULL&code=BCGcode128"></div>
                </div>
                ...
                <div class='footer_r'>
                    ...
                    <div class='footer_r_t'>
                        ...
                        <p class='p2'><!--{$order.paypalid}--></p>
                        <p class='p3'><!--{$smarty.now|date_format:'%Y-%m-%d'}--></p>
                    </div>
                </div>
                
                <div style='position:absolute;bottom:10px;right:10px;'><b>SZWWC</b></div>
            </div>
            
        </div>
        
        
        <div class='order_2 clear' style='margin-bottom:15px;margin-left:20px;'>

            <table cellpadding='0' cellspacing='0' class='tab1'>
                <tr class='tr1'>
                        <td colspan='4' >
                            <span class='span1'>CUSTOMS DECLARATION CN 23</span>  
                            <span class='span2'>May be opened officially</span>
                        </td>
                </tr>
                <tr class='tr2'>
                    <td >Desoription of contents</td>
                ...
                <tr class='tr3'>
                    <td><!--{$order.goodsarr[0].dec_name}--></td>
                    <td><!--{$order.goodsarr[0].goods_qty}--></td>
                    <td>0.100</td>
                ...
                <tr class='tr4'>
                    <td colspan='2'>
                        <span>Contents</span>
                        <span> <span style='border:1px solid #ccc;width:10px;height:10px;display:inline-block;'></span> Gift</span>
                        <span> <span style='border:1px solid #ccc;width:10px;height:10px;display:inline-block;'></span> Commercial sample</span>
                    </td>
                    <td>Total Wt</td>
                ...
                <tr class='tr5'>
                    <td colspan='2'>
                        <span>&nbsp;</span>
                        <span style='margin-left:42px;'> <span style='border:1px solid #ccc;width:10px;height:10px;display:inline-block;'></span> Documents</span>
                        <span><input type='checkbox' value='' checked='checked'/> Other</span>
                    </td>
                    <td>0.100</td>
                    <td style='border-right:none;'>5</td>
                </tr>
            ...
            <table class='tab2' cellspacing='0' cellpadding='0'>
                <tr class='tr6'>
                    <td colspan='2'>For commercial items only</td>
                    <td colspan='2'>License No:</td>
                </tr>
                <tr class='tr7'>
                    <td class='td1'>HS Tariff No:</td>
                    <td class='td1' style='font-size:10px;'>Country of origin:</td>
                    <td colspan='2' style='border-right:none;border-bottom:1px solid #231916;'>Certificate No:</td>
                </tr>
                <tr class='tr8'>
                    <td class='td1'>&nbsp;</td>
                    <td class='td1' style='font-weight:bold;text-align:center;font-size:14px;'>CN</td>
                    <td colspan='2' style='border-right:none;'>Invoice No:</td>
                </tr>
                <tr class='tr9'>
                    <td>Importer’s ref (taxcode/VAT no) if any:</td>
                    <td>Postage Fees:</td>
                    <td colspan='2' style='border-right:none;'>Office of origin/ Date of posting:</td>
                </tr>
                <tr class='tr10'>
                    <td colspan='4'>Comments: (eg: goods subject to quarantine, sanitary/phytosanitary inspection or otherrestrictions)</td>
                </tr>
                <tr class='tr11'>
                    <td colspan='4' >I certify that the particulars given in this customs declaration are correct and that this item doesnot contain any dangerous article prohibited by legislation or by postal or customs regulations.</td>
                </tr>
                <tr class='tr12'>
                    <td colspan='4'>
                        <span>Signature of sender:SUNYOU</span>
                        <span style='margin-left:20px;'>Date: <!--{$smarty.now|date_format:'%Y-%m-%d'}--></span>
                    </td>
                </tr>
            </table>
