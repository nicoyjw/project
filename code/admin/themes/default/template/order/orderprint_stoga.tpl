...
<li style="text-align: right;margin-top: 10px;"><img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=128&scale=1.1&rotation=0&font_family=Arial.ttf&font_size=10&text=<!--{$order.paypalid}-->&thickness=50&start=NULL&code=BCGcode128"></li>
<li style="clear:left;font-size:22px;margin-top:4px;font-family:Arial;"><b>TO:<!--{$order.consignee}--></b></li>
<li style="font-size:23px;font-family:Arial;"><b><!--{$order.street1}-->  <!--{$order.street2}-->,</li>
<li style="font-size:23px;width:320px;font-family:Arial;"><!--{$order.city}-->,<!--{$order.state}-->,</li>
<li style="font-size:23px;width:320px;font-family:Arial;"><b><!--{$order.country}-->  <!--{$order.zipcode}--></b></li>
<li style="font-size:23px;font-family:Arial;"><b><!--{$order.tel}--></b></li>         
...
<tr>
    ...
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
        <table style="font-size:12px;font-family:'PT Sans',Verdana,Tahoma,Arial,sans-serif;">
            <tr>
                <td style="padding:0;margin:0;text-align:left;" valign="top">
                <B>FROM:&nbsp;SRJS</B><p style="font-size:11px;font-family:'PT Sans',Verdana,Tahoma,Arial,sans-serif;">14 -ROOM 4102 SHENZHEN POSTAL EXPRESS SUPERVISION CENTER, JUNCTION OF QIAOXIZNG RD.&SHENYUN RD.,OCT NORTH,SHENZHEN</p>
                </td>
            </tr>
        </table>                      
        <table width="100%" cellpadding="0" cellspacing="0" class="tabBq1">  
            ...
            <tr>
                <td colspan="2" valign="bottom" style="font-size:10px;border-bottom : 1px solid #000;border-top: 1px solid #000;border-left: 1px solid #000;border-right: 1px solid #000;font-family:sans-serif;" align="center" colspan="2">中国邮政航空小包挂号（广东）&nbsp;<!--{$order.order_sn}-->&nbsp;RefNo:<!--{$order.paypalid}--></td>
            </tr>
        </table>
    </td>   
    ...
    <table cellpadding="0" cellspacing="0" style="font-size: 11px;font-family:Arial,sans-serif;">
        ...
        <tr height="25px">
            <td width="60%" align="center" style="border-right:1px solid #000;border-bottom:1px solid #000;padding-left:5px;">                 
                 <span><!--{$goods.dec_name}-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;X &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--{$goods.goods_qty}--></span>
            </td>
            <td style="border-bottom:1px solid #000;">
                <table style="font-size:11px;font-family:Arial,sans-serif;" cellpadding="0" cellspacing="0">
                   <tr height="30px">
                      <td width="80px" align="center" style="border-right:1px solid #000;"><!--{$goods.total_weight_val|string_format:"%.2f"}--></td>
                      <td align="center" style="padding-left:15px;"><!--{$goods.total_dec_val|string_format:"%.2f"}--></td>
                   </tr>
                </table>
            </td>
        </tr>
        ...
        <tr height="25px">
            ...
            <td style="border-bottom:1px solid #000;">
                <table style="font-size:10px;font-family:Arial,sans-serif;" cellpadding="0" cellspacing="0">
                   <tr height="28px">
                      <td width="80px" align="center" style="border-right: 1px solid #000;"><!--{$order.dec_weight_total|string_format:"%.2f"}--></td>
                      <td width="55px" align="center"><!--{$order.dec_val_total|string_format:"%.2f"}--></td>
                   </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding-left:5px;" colspan="2">
                (15)Date and sender's signature</span> <div style="text-align:right;padding-right:20px;font-style: italic;font-weight:bold">HLY SRJS</div>
            </td>
        </tr>
    </table>
</td>
      ...
      <tr> 
         <td valign="top">
            <table width="100%" height="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="word-break: break-all;break-all;position:relative; font-size: 10px;">
               <tr><td colspan="6"  valign="top" style="border-bottom:#000000 1px solid; border-left:#ffffff 1px solid;border-right:#ffffff 1px solid; border-top:#ffffff 1px solid; font-size: 10px;">
               ...
               <tr style="height: 25px;" valign="middle" align="center">
                  ...
                  <td style="border-bottom: 1px solid #000;border-left:1px solid #000;" width="30%"  valign="middle">
                      产品名称 
                  </td>
                  <td style="border-bottom: 1px solid #000;border-left:1px solid #000;" width="15%"  valign="middle">
                      SKU 
                  ...
                  <td style="border-bottom: 1px solid #000;border-left:1px solid #000;border-right: 1px solid #000;" width="18%"  valign="middle">
                      备注 
                  </td> 
               </tr>
               <!--{foreach from =$order.goodsarr item = goods name=goodsitem}}-->
...
<tr>
    <td valign="top"  style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;padding:5;padding-bottom:0;">
        <table style="font-size:10px;font-family:'PT Sans',Verdana,Tahoma,Arial,sans-serif;">
            <tr>
                <td style="width:180px;font-size:10px;font-family:'PT Sans',Verdana,Tahoma,Arial,sans-serif;"><b>FROM:&nbsp;</b> <B>SRJS</B><br>
 ...
 <td valign="top" style="width:88mm;height:85mm;border-left:1px;border: 1px;border-bottom-style: dashed;border-left-style: dashed;border-right-style: dashed;border-top-style: dashed;border-color: #000;">
    <table cellpadding="0" cellspacing="0" style="font-size: 11px;font-family:Arial,sans-serif;">
        ...
        <tr>
            <td style="padding-left:5px;" colspan="2">
                Date and sender's signature</span> <div style="text-align:right;padding-right:20px;font-style: italic;font-weight:bold">HLY SRJS</div>
            </td>
        </tr>
    </table>
</td>
...
<div style="margin-left: 25px;">
    <table style="border: 1px solid #000;width: 193mm;" cellpadding="0" cellspacing="0">
      <tr>
         <td width="30%"  valign="top" style="border-right:#000000 1px solid; font-size: 10px;">
            <div style="text-align:center;margin-top:10px;"><img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=8&text=<!--{$order.paypalid}-->&thickness=30&start=NULL&code=BCGcode128"></div><br />
         ...
         <td valign="top">
            <table width="100%" height="100%" align="center" border="0" cellspacing="0" cellpadding="0" style="word-break: break-all;break-all;position:relative; font-size: 10px;">
               <tr style="height: 25px;" valign="middle" align="center">
                  <td style="border-bottom: 1px solid #000;" width="15%" valign="middle">
                      图片
                  </td>
                  <td style="border-bottom: 1px solid #000;border-left:1px solid #000;" width="30%"  valign="middle">
                      产品名称 
                  ...
                  <td style="border-bottom: 1px solid #000;border-left:1px solid #000;" width="18%"  valign="middle">
                      备注 
                  </td> 
               </tr>
               <!--{foreach from =$order.goodsarr item = goods name=goodsitem}}-->
...
<!--{elseif $type eq 10}--><!--8*5-->
<!--{foreach from =$orders item = order name=orderitem}-->
<div style="font-family:Arial;padding:5px;" <!--{if $smarty.foreach.orderitem.last}--><!--{else}-->class="pagebreak"<!--{/if}-->>
   <table border="0" cellpadding="0" cellspacing="0" style="height: 43mm; width: 68mm">
      <tr>
        <td>
            付款日期：<!--{$order.paid_time}-->    
        </td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        <td>
            <!--{foreach from =$order.goodsarr item = goods name=goodsitem}-->  
                 ...
                 <span><!--{$goods.goods_sn}-->*<!--{$goods.goods_qty}--><!--{if $smarty.foreach.goodsitem.last}--><!--{else}-->,<!--{/if}--></span>
      ...
      <tr>
         <td width="100%" valign="top" align="left">
            <img src="common/lib/barcodegen/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=0&font_size=8&text=<!--{$order.paypalid}-->&thickness=35&start=NULL&code=BCGcode128">
            <br>
            <div align="left" style="font-size: 13px"><b><!--{$order.paypalid}--></b></div>
         </td>
      </tr>
   </table>
   </div><!--{/foreach}-->
