...
require_once CFG_PATH_LIB . 'PHPExcel/Writer/Excel5/Parser.php';
...
/** PHPExcel_RichText */
require_once CFG_PATH_LIB . 'PHPExcel/RichText.php';

/** PHPExcel_Shared_String */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/String.php';

/** PHPExcel_Shared_Excel5 */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/Excel5.php';

/** PHPExcel_Shared_Escher */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/Escher.php';

/** PHPExcel_Shared_Escher_DgContainer */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/Escher/DgContainer.php';

/** PHPExcel_Shared_Escher_DgContainer_SpgrContainer */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/Escher/DgContainer/SpgrContainer.php';

/** PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/Escher/DgContainer/SpgrContainer/SpContainer.php';
