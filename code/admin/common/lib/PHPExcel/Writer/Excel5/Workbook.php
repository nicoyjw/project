...
if (!defined('CFG_PATH_LIB')) {
	/**
	 * @ignore
	 */
	define('CFG_PATH_LIB', dirname(__FILE__) . '/../../../');
}

/** PHPExcel_Shared_Date */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/Date.php';

/** PHPExcel_Shared_String */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/String.php';

/** PHPExcel_Shared_Escher */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/Escher.php';

/** PHPExcel_Shared_Escher_DggContainer */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/Escher/DggContainer.php';

/** PHPExcel_Shared_Escher_DggContainer_BstoreContainer */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/Escher/DggContainer/BstoreContainer.php';

/** PHPExcel_Shared_Escher_DggContainer_BstoreContainer_BSE */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/Escher/DggContainer/BstoreContainer/BSE.php';

/** PHPExcel_Shared_Escher_DggContainer_BstoreContainer_BSE_Blip */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/Escher/DggContainer/BstoreContainer/BSE/Blip.php';

/** PHPExcel_Writer_Excel5_Xf */
require_once CFG_PATH_LIB . 'PHPExcel/Writer/Excel5/Xf.php';

/** PHPExcel_Writer_Excel5_BIFFwriter */
require_once CFG_PATH_LIB . 'PHPExcel/Writer/Excel5/BIFFwriter.php';

/** PHPExcel_Writer_Excel5_Worksheet */
require_once CFG_PATH_LIB . 'PHPExcel/Writer/Excel5/Worksheet.php';

/** PHPExcel_Writer_Excel5_Font */
require_once CFG_PATH_LIB . 'PHPExcel/Writer/Excel5/Font.php';

/** PHPExcel_Writer_Excel5_Escher */
require_once CFG_PATH_LIB . 'PHPExcel/Writer/Excel5/Escher.php';
