...
require_once CFG_PATH_LIB . 'PHPExcel/Shared/OLE/OLE_Root.php';

/** PHPExcel_Shared_OLE_PPS_File */
require_once CFG_PATH_LIB . 'PHPExcel/Shared/OLE/OLE_File.php';

/** PHPExcel_Writer_Excel5_Parser */
require_once CFG_PATH_LIB . 'PHPExcel/Writer/Excel5/Parser.php';

/** PHPExcel_Writer_Excel5_Workbook */
require_once CFG_PATH_LIB . 'PHPExcel/Writer/Excel5/Workbook.php';
