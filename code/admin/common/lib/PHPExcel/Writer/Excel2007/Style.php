...
require_once CFG_PATH_LIB . 'PHPExcel/Writer/Excel2007.php';

/** PHPExcel_Writer_Excel2007_WriterPart */
require_once CFG_PATH_LIB . 'PHPExcel/Writer/Excel2007/WriterPart.php';

/** PHPExcel_Style */
require_once CFG_PATH_LIB . 'PHPExcel/Style.php';

/** PHPExcel_Style_Borders */
require_once CFG_PATH_LIB . 'PHPExcel/Style/Borders.php';

/** PHPExcel_Style_Border */
require_once CFG_PATH_LIB . 'PHPExcel/Style/Border.php';

/** PHPExcel_Style_Color */
require_once CFG_PATH_LIB . 'PHPExcel/Style/Color.php';

/** PHPExcel_Style_Fill */
require_once CFG_PATH_LIB . 'PHPExcel/Style/Fill.php';

/** PHPExcel_Style_Font */
require_once CFG_PATH_LIB . 'PHPExcel/Style/Font.php';

/** PHPExcel_Style_NumberFormat */
require_once CFG_PATH_LIB . 'PHPExcel/Style/NumberFormat.php';

/** PHPExcel_Style_Conditional */
require_once CFG_PATH_LIB . 'PHPExcel/Style/Conditional.php';

/** PHPExcel_Style_Protection */
require_once CFG_PATH_LIB . 'PHPExcel/Style/Protection.php';
