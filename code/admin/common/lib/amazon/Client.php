...
class MarketplaceWebServiceOrders_Client implements MarketplaceWebServiceOrders_Interface
{
   ...
   private function collapseWhitespace($s) {
    ...
    public function listOrdersByNextToken($request)
    {
        ...
        return $this->_invoke($this->_convertListOrdersByNextToken($request));
    }
    ...
    public function listOrderItemsByNextToken($request)
    {
        ...
        return $this->_invoke($this->_convertListOrderItemsByNextToken($request));
    }
    ...
    public function getOrder($request)
    {
        ...
        return $this->_invoke($this->_convertGetOrder($request));
    }
    ...
    public function listOrderItems($request)
    {
        ...
        return $this->_invoke($this->_convertListOrderItems($request));
    }
    ...
    public function listOrders($request)
    {
        ...
        return $this->_invoke($this->_convertListOrders($request));
    }
    ...
    public function getServiceStatus($request)
    {
        ...
        return $this->_invoke($this->_convertGetServiceStatus($request));
    }
