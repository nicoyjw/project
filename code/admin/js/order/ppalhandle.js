Ext.define('Ext.ux.depotmanagerView',{
        ...
        return Ext.create('Ext.toolbar.Toolbar',{
            items:['Shipping:','-',{
                   ...
                   '-',{
                        ...
                        store:Ext.create('Ext.data.ArrayStore',{
                            fields: ["id", "template"],
                            data: [['PDF_10_EN_URL', '10*10英文'],['PDF_A4_EN_URL', 'A4英文'] ]
                        }),
                        value:'PDF_10_EN_URL'
                        },'->',account,'-',time_type,
                    {
    ...
    creatBbar: function() {
       ...
       return Ext.create('Ext.toolbar.Paging',{
            ...
            items:[
                       ...
                       text:'提交预报',
                       pressed:true,
                       handler:this.updatePYB.bind(this,['0'])
                       },'-',{
                                xtype:'combo',
                                id:'printsort',
                                mode:'local',
                       ...
                       },'-','<a onclick="window.open(\'http://www.ppbyb.com/\')" href="#">贝邮宝登录</a>']                   
        });
    },  
    updatePYB:function(){
        ...
        mk.show(); 
        Ext.Ajax.request({
            url:'index.php?model=order&action=GetPPpackagetracking',
            timeout:90000000,
            loadMask:true,
            success:function(response){
                mk.hide();
            ...
            params:{id:ids,labeltype:Ext.getCmp('labeltype').getValue()}             
        });
    ...
    zhylabel:function(){
        Ext.Msg.alert('MSG','请点击订单列表里的PDF链接打开中环运标签。');                
    },
