    ...
    creatBbar: function() {
       ...
       return Ext.create('Ext.toolbar.Paging',{
            ...
            items:[
                       ...
                       },'-','<a onclick="window.open(\'http://sysorder.zhy-sz.com/login.aspx\')" href="#">中环运登录</a> &nbsp;&nbsp;<a onclick="window.open(\'http://www.cpowersoft.com/blog/?p=2454\')" href="#">查看渠道代码</a>']                   
        });
    },  
    updateZhy:function(){
        ...
        mk.show(); 
        Ext.Ajax.request({
            url:'index.php?model=order&action=Getzhytracking',
            timeout:300000,
            loadMask:true,
